...
class StableDiffusionClassPromptsPipeline(StableDiffusionPipeline):
    def _encode_prompt(
        ...
        class_prompts_embeds: Optional[torch.FloatTensor] = None,
        ...
        if class_prompts_embeds is None:
            # textual inversion: procecss multi-vector tokens if necessary
            if isinstance(self, TextualInversionLoaderMixin):
                class_prompts = self.maybe_convert_prompt(class_prompts, self.tokenizer)
        ...
        if do_classifier_free_guidance:
            ...
            prompt_embeds = torch.cat([negative_prompt_embeds, prompt_embeds, class_prompts_embeds])
    ...
    def __call__(
        ...
        class_prompts: Union[str, List[str]] = None,
        ...
        prompt_embeds = self._encode_prompt(
            ...
            class_prompts_embeds=class_prompts_embeds,
