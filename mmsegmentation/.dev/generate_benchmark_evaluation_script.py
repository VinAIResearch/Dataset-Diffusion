...
def parse_args():
    parser = argparse.ArgumentParser(description="Convert benchmark test model list to script")
    parser.add_argument("config", help="test config file path")
    parser.add_argument("--port", type=int, default=28171, help="dist port")
    parser.add_argument("--work-dir", default="work_dirs/benchmark_evaluation", help="the dir to save metric")
    parser.add_argument(
        "--out", type=str, default=".dev/benchmark_evaluation.sh", help="path to save model benchmark script"
    )
