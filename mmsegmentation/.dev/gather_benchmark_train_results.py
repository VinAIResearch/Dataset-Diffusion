...
def parse_args():
    parser = argparse.ArgumentParser(description="Gather benchmarked models train results")
    parser.add_argument("config", help="test config file path")
    parser.add_argument("root", type=str, help="root path of benchmarked models to be gathered")
    parser.add_argument(
        "--out", type=str, default="benchmark_train_info.json", help="output path of gathered metrics to be stored"
    )
