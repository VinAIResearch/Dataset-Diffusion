...
model = dict(
    ...
    decode_head=dict(
        ...
        align_corners=False,
        loss_decode=[
            dict(type="CrossEntropyLoss", use_sigmoid=False, loss_weight=1.0, loss_name="loss_o"),
            dict(type="CrossEntropyLoss", use_sigmoid=False, loss_weight=0.4, loss_name="loss_d"),
        ],
    ),
    auxiliary_head=dict(
        type="FCNHead",
