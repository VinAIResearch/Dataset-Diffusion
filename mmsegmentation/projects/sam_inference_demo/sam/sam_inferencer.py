...
class SAMInferencer:
    def __init__(self, arch: str = "base") -> None:
        ...
        self.transform = TRANSFORMS.build(
            dict(type="ResizeLongestSide", target_length=max(self.model.image_encoder.img_size))
        )
    ...
    def set_torch_image(
        ...
        assert (
            ...
            and max(*transformed_image.shape[2:]) == max(self.model.image_encoder.img_size)
