...
def init_model(
    ...
    if checkpoint is not None:
        ...
        if "dataset_meta" in checkpoint.get("meta", {}):
            ...
            model.dataset_meta = {"classes": get_classes(dataset_name), "palette": get_palette(dataset_name)}
...
def show_result_pyplot(
    ...
    # init visualizer
    visualizer = SegLocalVisualizer(vis_backends=[dict(type="LocalVisBackend")], save_dir=save_dir, alpha=opacity)
    visualizer.dataset_meta = dict(classes=model.dataset_meta["classes"], palette=model.dataset_meta["palette"])
