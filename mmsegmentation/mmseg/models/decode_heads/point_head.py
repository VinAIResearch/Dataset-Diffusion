...
class PointHead(BaseCascadeDecodeHead):
    ...
    def loss(self, inputs, prev_output, batch_data_samples: SampleList, train_cfg, **kwargs):
    ...
    def predict(self, inputs, prev_output, batch_img_metas: List[dict], test_cfg, **kwargs):
        ...
        return self.predict_by_feat(refined_seg_logits, batch_img_metas, **kwargs)
    ...
    def loss_by_feat(self, point_logits, points, batch_data_samples, **kwargs):
        ...
        point_label = point_sample(gt_semantic_seg.float(), points, mode="nearest", align_corners=self.align_corners)
