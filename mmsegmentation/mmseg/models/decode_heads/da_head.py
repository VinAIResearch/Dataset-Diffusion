...
class DAHead(BaseDecodeHead):
    ...
    def loss_by_feat(self, seg_logit: Tuple[Tensor], batch_data_samples: SampleList, **kwargs) -> dict:
        ...
        loss.update(add_prefix(super().loss_by_feat(pam_seg_logit, batch_data_samples), "pam"))
        loss.update(add_prefix(super().loss_by_feat(cam_seg_logit, batch_data_samples), "cam"))
        return loss
