...
from mmseg.utils import ForwardResults, OptConfigType, OptMultiConfig, OptSampleList, SampleList
...
class BaseSegmentor(BaseModel, metaclass=ABCMeta):
    ...
    def postprocess_result(self, seg_logits: Tensor, data_samples: OptSampleList = None) -> SampleList:
        ...
        for i in range(batch_size):
            ...
            data_samples[i].set_data(
                {"seg_logits": PixelData(**{"data": i_seg_logits}), "pred_sem_seg": PixelData(**{"data": i_seg_pred})}
            )
