...
class iSAIDDataset(BaseSegDataset):
    ...
    def __init__(
        self, img_suffix=".png", seg_map_suffix="_instance_color_RGB.png", ignore_index=255, **kwargs
    ) -> None:
        super().__init__(img_suffix=img_suffix, seg_map_suffix=seg_map_suffix, ignore_index=ignore_index, **kwargs)
