...
class DRIVEDataset(BaseSegDataset):
    ...
    METAINFO = dict(classes=("background", "vessel"), palette=[[120, 120, 120], [6, 230, 230]])

    def __init__(self, img_suffix=".png", seg_map_suffix="_manual1.png", reduce_zero_label=False, **kwargs) -> None:
        super().__init__(
