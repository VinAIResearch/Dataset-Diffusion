...
class TestPackSegInputs(unittest.TestCase):
    def setUp(self):
        ...
        self.meta_keys = ("img_path", "ori_shape", "img_shape", "pad_shape", "scale_factor", "flip", "flip_direction")
    ...
    def test_transform(self):
        ...
        self.assertIsInstance(results["data_samples"].gt_sem_seg, BaseDataElement)
        self.assertEqual(results["data_samples"].ori_shape, results["data_samples"].gt_sem_seg.shape)
    ...
    def test_repr(self):
        transform = PackSegInputs(meta_keys=self.meta_keys)
        self.assertEqual(repr(transform), f"PackSegInputs(meta_keys={self.meta_keys})")
