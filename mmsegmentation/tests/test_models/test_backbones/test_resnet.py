...
def test_resnet_backbone():
    ...
    with pytest.raises(AssertionError):
        ...
        plugins = [
            dict(cfg=dict(type="ContextBlock", ratio=1.0 / 16), stages=(False, True, True), position="after_conv3")
        ]
    ...
    plugins = [
        ...
        dict(cfg=dict(type="NonLocal2d"), position="after_conv2"),
        dict(cfg=dict(type="ContextBlock", ratio=1.0 / 16), stages=(False, True, True, False), position="after_conv3"),
    ]
