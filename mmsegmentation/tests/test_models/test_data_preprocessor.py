...
class TestSegDataPreProcessor(TestCase):
    ...
    def test_forward(self):
        ...
        data_sample.gt_sem_seg = PixelData(**{"data": torch.randint(0, 10, (1, 11, 10))})
        processor = SegDataPreProcessor(mean=[0, 0, 0], std=[1, 1, 1], size=(20, 20))
        data = {
            "inputs": [torch.randint(0, 256, (3, 11, 10)), torch.randint(0, 256, (3, 11, 10))],
        ...
        processor = SegDataPreProcessor(mean=[0, 0, 0], std=[1, 1, 1], size=(20, 20), test_cfg=dict(size_divisor=15))
        data = {
            "inputs": [
