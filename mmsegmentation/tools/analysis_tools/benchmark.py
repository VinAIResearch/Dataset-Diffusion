...
def parse_args():
    ...
    parser.add_argument("--work-dir", help=("if specified, the results will be dumped " "into the directory as json"))
...
def main():
    ...
    print(f"Average fps of {repeat_times} evaluations: " f'{benchmark_dict["average_fps"]}')
    print(f"The variance of {repeat_times} evaluations: " f'{benchmark_dict["fps_variance"]}')
