...
def parse_args():
    parser = argparse.ArgumentParser(description="Convert LoveDA dataset to mmsegmentation format")
...
def main():
    ...
    assert "Train.zip" in os.listdir(dataset_path), f"Train.zip is not in {dataset_path}"
