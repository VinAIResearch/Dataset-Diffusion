...
def parse_args():
    parser = argparse.ArgumentParser(description="Convert iSAID dataset to mmsegmentation format")
...
def main():
    ...
    assert os.path.exists(os.path.join(dataset_path, "train")), f"train is not in {dataset_path}"
    assert os.path.exists(os.path.join(dataset_path, "val")), f"val is not in {dataset_path}"
    assert os.path.exists(os.path.join(dataset_path, "test")), f"test is not in {dataset_path}"
